...
#Originally part of script 'Expt1 Analysis2' and 'Expt 1 Analysis Script 2.0'/'Expt 1 Stat Analysis'
#Edited for analysis of Expt 4 data
...
x2 <- dShell[c(9,15,23,24,32,33,34)]
...
#basically, all of this seems to indicate starting mass (mass1), finalSA, thickness, densityMV, and volume are significant 

#Third data frame with categorical variables for a ....
#Mixed model!
x3 <- data.frame(scale(log(dShell[c(9,15,23,24,32,33,34)])))
...
#both taxon and expt ID count for some percentage of the total dissolution, but exptID is MUCH less significant in this one
#in total, 86.26% variance explained by the full
library(MuMIn)
